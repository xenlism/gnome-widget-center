...
- `products/extension/lib/widgetLayer.js` (สร้างใหม่)
- `products/extension/extension.js` (แก้ให้สร้าง/ทำลาย WidgetLayer และเชื่อมกับ loader)
...
แต่ไม่เคยทำงานตาม data flow ที่ `development/docs/ARCHITECTURE.md` §4 กำหนดไว้จริง:
