...
export const WidgetEditToolbar = GObject.registerClass(class WidgetEditToolbar extends St.BoxLayout {
    _init(params = {}) {
        super._init({
    ...
    _setMoveIcon(button) {
        const iconCandidates = [ "transform-move-symbolic", "view-fullscreen-symbolic", "open-menu-symbolic" ];
