...
export default class GeekClockDateBigWidget {
    ...
    buildActor() {
        this._layers = createLayeredCard({
            contentStyleClass: "geek-clock-date-big-widget-root"
        });
        ...
        this._clockLabel = new St.Label({
            style_class: "geek-clock-date-big-widget-clock",
            x_expand: true
        });
        this._dateLabel = new St.Label({
            style_class: "geek-clock-date-big-widget-date",
            x_expand: true
        });
    ...
    _render() {
        ...
        const {family: clockFontFamily, size: clockFontSize} = _parseFontDescription(this._settings.clockFont ?? "Sans Bold 56", "Sans Bold", 56);
