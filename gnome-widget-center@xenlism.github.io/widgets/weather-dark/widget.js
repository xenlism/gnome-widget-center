...
export default class WeatherDarkWidget {
    constructor(api) {
        ...
        this._cacheDir = Gio.File.new_for_path(GLib.build_filenamev([ GLib.get_user_cache_dir(), "gnome-widget-center", "weather-dark" ]));
        this._translations = {};
    }
    _loadI18n() {
    ...
    buildActor() {
        ...
        this._conditionLabel = new St.Label({
            style_class: "weather-dark-widget-condition"
        });
    ...
    _render() {
        ...
        this._tempLabel.set_style(`color: ${tempColor}; font-family: ${tempFontFamily}; ` + `font-size: ${tempFontSize}px; font-weight: bold;`);
        this._conditionLabel.set_text(this._weather ? this._trCondition(this._weather.condition) : "--");
        this._conditionLabel.set_style(`color: ${conditionColor}; font-family: ${conditionFontFamily}; ` + `font-size: ${conditionFontSize}px;`);
    }
}