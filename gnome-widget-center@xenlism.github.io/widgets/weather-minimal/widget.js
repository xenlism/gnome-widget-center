...
export default class WeatherMinimalWidget {
    constructor(api) {
        ...
        this._cacheDir = Gio.File.new_for_path(GLib.build_filenamev([ GLib.get_user_cache_dir(), "gnome-widget-center", "weather-minimal" ]));
        this._translations = {};
    }
    _loadI18n() {
    ...
    buildActor() {
        ...
        this._conditionLabel = new St.Label({
            style_class: "weather-minimal-widget-condition"
        });
    ...
    _render() {
        ...
        this._conditionLabel.set_style(`color: ${conditionColor}; font-family: ${conditionFontFamily}; ` + `font-size: ${conditionFontSize}px; font-weight: bold; text-align: center;`);
        let tempText = "--";
        if (this._weather) {
        ...
        this._tempLabel.set_style(`color: ${tempColor}; font-family: ${tempFontFamily}; ` + `font-size: ${tempFontSize}px; font-weight: bold; text-align: center;`);
    }
}