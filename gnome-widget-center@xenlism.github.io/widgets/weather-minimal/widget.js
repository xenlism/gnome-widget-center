...
// weather widgets (widgetConfigUI.js's _locationRow(), see
// PROJECT_STATUS.md's 2026-07-31 entry) - so widget.js itself never
...
export default class WeatherMinimalWidget {
    ...
    _render() {
        ...
        this._actor.set_style(
            _cardStyleCss(this._settings, {backgroundColorKey: 'cardColor', backgroundColorFallback: '#ffffff', cornerRadiusFallback: 18}) +
