...
export default class GeekWeekDateBayWidget {
    ...
    buildActor() {
        this._layers = createLayeredCard({
            contentStyleClass: "geek-week-date-bay-widget-root"
        });
        ...
        this._topLabel = new St.Label({
            style_class: "geek-week-date-bay-widget-top",
            x_expand: true
        });
        this._bottomLabel = new St.Label({
            style_class: "geek-week-date-bay-widget-bottom",
            x_expand: true
        });
    ...
    _render() {
        ...
        const {family: weekFontFamily, size: weekFontSize} = _parseFontDescription(this._settings.weekFont ?? "Sans Bold 32", "Sans Bold", 32);
        const {family: dateFontFamily, size: dateFontSize} = _parseFontDescription(this._settings.dateFont ?? "Sans Bold 16", "Sans Bold", 16);
