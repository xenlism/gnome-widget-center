// widgets/geek-clock-date-bar/widget.js
//
// "Geek" clock + date card - a wide `barx3` card (35×5 grid cells),
...
export default class GeekClockDateBarWidget {
    ...
    buildActor() {
        ...
        this._clockLabel = new St.Label({style_class: 'geek-clock-date-bar-widget-clock', x_expand: true});
        this._dateLabel = new St.Label({style_class: 'geek-clock-date-bar-widget-date', x_expand: true});
    ...
    _render() {
        ...
        const {family: clockFontFamily, size: clockFontSize} =
            _parseFontDescription(this._settings.clockFont ?? 'Sans Bold 30', 'Sans Bold', 30);
