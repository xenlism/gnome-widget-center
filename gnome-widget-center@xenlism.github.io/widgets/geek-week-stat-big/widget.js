// widgets/geek-week-stat-big/widget.js
//
// "Geek" week + stat card - a large `4x1` card (47×11 grid cells),
...
export default class GeekWeekStatBigWidget {
    ...
    buildActor() {
        this._actor = new St.BoxLayout({
            style_class: 'geek-week-stat-big-widget-root',
            vertical: true,
            x_align: Clutter.ActorAlign.CENTER,
        });

        this._topLabel = new St.Label({style_class: 'geek-week-stat-big-widget-top', x_expand: true});
        this._bottomLabel = new St.Label({style_class: 'geek-week-stat-big-widget-bottom', x_expand: true});
