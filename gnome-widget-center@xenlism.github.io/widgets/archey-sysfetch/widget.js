...
export default class SysfetchWidget {
    ...
    getDefaultSettings() {
        return {
            ...SHADOW_DEFAULTS,
            // On by default here (unlike SHADOW_DEFAULTS' box-shadow,
            // which stays opt-in) - stat text sitting directly on a
            // translucent/blurred desktop background is otherwise hard to
            // read against busy wallpapers. 90deg/0px/5px = a plain soft
            // drop straight down.
