...
export default class GeekClockDateBayWidget {
    ...
    _render() {
        ...
        const {family: clockFontFamily, size: clockFontSize} = _parseFontDescription(this._settings.clockFont ?? "Sans Bold 40", "Sans Bold", 40);
        const {family: dateFontFamily, size: dateFontSize} = _parseFontDescription(this._settings.dateFont ?? "Sans Bold 18", "Sans Bold", 18);
