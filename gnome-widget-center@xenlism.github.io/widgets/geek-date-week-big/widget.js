// widgets/geek-date-week-big/widget.js
//
// "Geek" date + week card - a large `4x1` card (47×11 grid cells),
...
export default class GeekDateWeekBigWidget {
    ...
    buildActor() {
        ...
        this._topLabel = new St.Label({style_class: 'geek-date-week-big-widget-top', x_expand: true});
        this._bottomLabel = new St.Label({style_class: 'geek-date-week-big-widget-bottom', x_expand: true});
