...
export default class GeekWeekDateBarWidget {
    ...
    buildActor() {
        ...
        this._topLabel = new St.Label({
            style_class: "geek-week-date-bar-widget-top",
            x_expand: true
        });
        this._bottomLabel = new St.Label({
            style_class: "geek-week-date-bar-widget-bottom",
            x_expand: true
        });
    ...
    _render() {
        ...
        const {family: dateFontFamily, size: dateFontSize} = _parseFontDescription(this._settings.dateFont ?? "Sans Bold 12", "Sans Bold", 12);
