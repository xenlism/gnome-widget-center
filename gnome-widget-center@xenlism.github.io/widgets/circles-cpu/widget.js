// widgets/circles-cpu/widget.js
//
// 1x1 card: a single ring gauge (base track + CPU-usage progress arc)
// with the "CPU" caption and the live percentage centered inside it -
...
export default class CirclesCpuWidget {
    ...
    buildActor() {
        ...
        this._labelLabel = new St.Label({text: 'CPU', style_class: 'circles-cpu-label'});
        this._valueLabel = new St.Label({text: '0%', style_class: 'circles-cpu-value'});
    ...
    _launchApp() {
        ...
        try {
            ...
            if (appInfo)
                ...
                this._api.logger.info(`circles-cpu: could not read .desktop file at ${path}`);
        } catch (e) {
            this._api.logger.info(`circles-cpu: failed to launch ${path}: ${e}`);
        }
    }
