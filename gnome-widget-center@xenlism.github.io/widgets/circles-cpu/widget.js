...
export default class CirclesCpuWidget {
    ...
    buildActor() {
        this._layers = createLayeredCard({
            contentStyleClass: "circles-cpu-root"
        });
        ...
        this._labelLabel = new St.Label({
            text: "CPU",
            style_class: "circles-cpu-label"
        });
        this._valueLabel = new St.Label({
            text: "0%",
            style_class: "circles-cpu-value"
        });
    ...
    _launchApp() {
        ...
        try {
            ...
            if (appInfo) appInfo.launch([], null); else this._api.logger.info(`circles-cpu: could not read .desktop file at ${path}`);
        } catch (e) {
