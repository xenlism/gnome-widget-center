...
Medium `3x1` card (35×11 grid cells) with two centered lines:
...
- **Date text** — font face/size (`dateFont`) and color (`dateColor`) for the top line.
- **Week text** — font face/size (`weekFont`) and color (`weekColor`) for the bottom line.
