// widgets/geek-date-week-bay/widget.js
//
// "Geek" date + week card - a medium `3x1` card (35×11 grid cells),
...
export default class GeekDateWeekBayWidget {
    ...
    buildActor() {
        this._actor = new St.BoxLayout({
            style_class: 'geek-date-week-bay-widget-root',
            vertical: true,
            x_align: Clutter.ActorAlign.CENTER,
        });

        this._topLabel = new St.Label({style_class: 'geek-date-week-bay-widget-top', x_expand: true});
        this._bottomLabel = new St.Label({style_class: 'geek-date-week-bay-widget-bottom', x_expand: true});
    ...
    getDefaultSettings() {
        return {
            ...
            dateFont: 'Sans Bold 32',
            dateColor: '#ffffff',
            weekFont: 'Sans Bold 16',
            weekColor: '#e6e6e6',
    ...
    _render() {
        ...
        const {family: dateFontFamily, size: dateFontSize} =
            _parseFontDescription(this._settings.dateFont ?? 'Sans Bold 32', 'Sans Bold', 32);
        const {family: weekFontFamily, size: weekFontSize} =
            _parseFontDescription(this._settings.weekFont ?? 'Sans Bold 16', 'Sans Bold', 16);
