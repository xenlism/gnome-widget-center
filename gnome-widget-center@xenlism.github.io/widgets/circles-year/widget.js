...
export default class CirclesYearWidget {
    ...
    buildActor() {
        this._layers = createLayeredCard({
            contentStyleClass: "circles-year-root"
        });
        ...
        this._yearLabel = new St.Label({
            style_class: "circles-year-value"
        });
        this._dayLabel = new St.Label({
            style_class: "circles-year-day"
        });
    ...
    _render() {
        ...
        this._yearLabel.set_style(`color: ${yearColor}; font-family: ${yearFont.family}; ` + `font-size: ${yearFont.size}px; font-weight: bold; text-align: center;`);
        this._dayLabel.set_style(`color: ${dayColor}; font-family: ${dayFont.family}; ` + `font-size: ${dayFont.size}px; text-align: center;`);
        if (this._ringArea) this._ringArea.queue_repaint();
    }
    _onRepaint() {
