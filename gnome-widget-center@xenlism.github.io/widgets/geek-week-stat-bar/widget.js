// widgets/geek-week-stat-bar/widget.js
//
// "Geek" week + stat card - a wide `barx2` card (23×5 grid cells),
...
export default class GeekWeekStatBarWidget {
    ...
    buildActor() {
        ...
        this._topLabel = new St.Label({style_class: 'geek-week-stat-bar-widget-top', x_expand: true});
        this._bottomLabel = new St.Label({style_class: 'geek-week-stat-bar-widget-bottom', x_expand: true});
