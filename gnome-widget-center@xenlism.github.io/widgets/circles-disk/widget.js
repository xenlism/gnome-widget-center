...
export default class CirclesDiskWidget {
    ...
    buildActor() {
        this._layers = createLayeredCard({
            contentStyleClass: "circles-disk-root"
        });
        ...
        this._labelLabel = new St.Label({
            text: "DISK",
            style_class: "circles-disk-label"
        });
        this._valueLabel = new St.Label({
            text: "0%",
            style_class: "circles-disk-value"
        });
    ...
    _tick() {
        ...
        const {percent: percent} = this._getDiskUsage(diskPath);
    ...
    _launchApp() {
        ...
        try {
            ...
            if (appInfo) appInfo.launch([], null); else this._api.logger.info(`circles-disk: could not read .desktop file at ${path}`);
        } catch (e) {
