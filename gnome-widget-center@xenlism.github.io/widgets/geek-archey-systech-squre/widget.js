// widgets/geek-archey-systech-squre/widget.js
//
...
export default class GeekArcheySystechSqureWidget {
    ...
    buildActor() {
        ...
        this._sepLabel = new St.Label({style_class: 'geek-archey-systech-squre-sep'});
        ...
        for (const [key, label, color] of ROW_DEFS) {
            const row = new St.BoxLayout({vertical: false, style_class: 'geek-archey-systech-squre-row'});
            const bullet = new St.Label({text: '\u25A0', style_class: 'geek-archey-systech-squre-bullet'});
            const value = new St.Label({style_class: 'geek-archey-systech-squre-value'});
