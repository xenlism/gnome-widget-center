...
export default class GeekArcheySystechSqureWidget {
    ...
    buildActor() {
        this._layers = createLayeredCard({
            contentStyleClass: "geek-archey-systech-squre-root"
        });
        ...
        this._headerLabel = new St.Label({
            style_class: "geek-archey-systech-squre-header"
        });
        infoBox.add_child(this._headerLabel);
        this._sepLabel = new St.Label({
            style_class: "geek-archey-systech-squre-sep"
        });
        ...
        for (const [key, label, color] of ROW_DEFS) {
            ...
            const bullet = new St.Label({
                text: "■",
                style_class: "geek-archey-systech-squre-bullet"
            });
            const value = new St.Label({
                style_class: "geek-archey-systech-squre-value"
            });
        ...
        this._layers.content.add_child(infoBox);
        this._render();
        return this._actor;
    }
    enable() {
    ...
    _render() {
        ...
        this._headerLabel.set_style(`font-family: monospace; font-size: 10px; font-weight: bold; color: #ffffff;${textShadow}`);
