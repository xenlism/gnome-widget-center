...
อ่าน `docs/ARCHITECTURE.md` ทั้งหมดก่อน โดยเฉพาะหัวข้อ 2.1 และ 6

## Files to touch

- `extension/metadata.json` (สร้างใหม่)
- `extension/extension.js` (สร้างแบบ minimal — แค่พอ enable/disable ได้)
- `tasks/00-project-setup.md` (ไฟล์นี้เอง — เพิ่ม notes ท้ายไฟล์หลังทดลองเสร็จ)
