...
- `extension/lib/dragController.js` (สร้างใหม่) — **ทำแล้ว (2026-07-14)**: `attach(widgetId,
...
- **ยังไม่ได้ทดสอบบน GNOME Shell/Clutter จริง** (container นี้ไม่มี Wayland/X11 session ให้รัน)
  ...
  ควรลองมือบนเครื่องที่มี GNOME Shell 45+ จริงตาม checklist ใน `docs/WIDGET_API.md` §7
