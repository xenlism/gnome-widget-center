 ...
 * inside the extension (`extension/schemas/`), never installed system-wide.
 *
 ...
 * docs/SETTINGS_SPEC.md) อ้างอิงตามสเปก: docs/ARCHITECTURE.md §2.3
 *
 ...
 * ไม่เคยถูกติดตั้งตรงนั้น (compile ไว้ใน `extension/schemas/` เอง) ดังนั้น
...
export class SettingsService {
    ...
    init() {
        ...
        // getSettings() looks up extension/schemas/gschemas.compiled inside
