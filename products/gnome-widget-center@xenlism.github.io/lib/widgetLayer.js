 ...
 * — see development/tasks/07-multi-monitor-support.md), each inserted at the
 ...
 * `buildActor()` per development/docs/WIDGET_API.md) — this layer does not know or care
 ...
 * เขียนใหม่ให้ตรงกับสัญญาที่ development/tasks/02-widget-layer-rendering.md กำหนดไว้เอง
 *
...
export class WidgetLayer {
    ...
    _createContainer(monitor) {
        ...
        // Validated in development/tasks/00-project-setup.md "Notes from implementation":
     ...
     * reorder). Per development/tasks/07-multi-monitor-support.md:
