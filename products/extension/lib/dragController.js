// products/extension/lib/dragController.js
//
...
// development/tasks/04-drag-reposition.md for why there is no DBus/SQLite service in
...
export class DragController {
     ...
     *   criteria in development/tasks/04-drag-reposition.md).
     */
